...
// 	/** \addtogroup studio */
	...
	void MainWindow::showUserManual()
	{
		...
		if (target->getLanguage().left(2) == "fr")
			helpViewer->setSource(QString("qrc:/doc/fr_asebausermanual.html"));
		else if (target->getLanguage().left(2) == "de")
			helpViewer->setSource(QString("qrc:/doc/de_asebausermanual.html"));
		else
			helpViewer->setSource(QString("qrc:/doc/en_asebausermanual.html"));
		helpViewer->moveCursor(QTextCursor::Start);
		helpViewer->setWindowTitle(tr("Aseba Studio Help: User Manual"));
		helpViewer->show();
	}
	...
	void MainWindow::showHelpLanguage()
	{
		...
		if (target->getLanguage().left(2) == "fr")
			helpViewer->setSource(QString("qrc:/doc/fr_asebalanguage.html"));
		else if (target->getLanguage().left(2) == "de")
			helpViewer->setSource(QString("qrc:/doc/de_asebalanguage.html"));
		else
			helpViewer->setSource(QString("qrc:/doc/en_asebalanguage.html"));
		helpViewer->moveCursor(QTextCursor::Start);
	...
	void MainWindow::showHelpStudio()
	{
		// help files generated by txt2tags, xhtml mode, with TOC
		if (target->getLanguage().left(2) == "fr")
			helpViewer->setSource(QString("qrc:/doc/fr_asebastudio.html"));
		else if (target->getLanguage().left(2) == "de")
			helpViewer->setSource(QString("qrc:/doc/de_asebastudio.html"));
		else
			helpViewer->setSource(QString("qrc:/doc/en_asebastudio.html"));
		helpViewer->moveCursor(QTextCursor::Start);

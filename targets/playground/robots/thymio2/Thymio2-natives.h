...
#	define PLAYGROUND_THYMIO2_NATIVES_DESCRIPTIONS                                                               \
		&PlaygroundThymio2NativeDescription_sound_record, &PlaygroundThymio2NativeDescription_sound_play,         \
			&PlaygroundThymio2NativeDescription_sound_replay, &PlaygroundThymio2NativeDescription_sound_system,   \
			&PlaygroundThymio2NativeDescription_leds_circle, &PlaygroundThymio2NativeDescription_leds_top,        \
			&PlaygroundThymio2NativeDescription_leds_bottom_right,                                                \
			&PlaygroundThymio2NativeDescription_leds_bottom_left, &PlaygroundThymio2NativeDescription_sound_freq, \
			&PlaygroundThymio2NativeDescription_leds_buttons, &PlaygroundThymio2NativeDescription_leds_prox_h,    \
			&PlaygroundThymio2NativeDescription_leds_prox_v, &PlaygroundThymio2NativeDescription_leds_rc,         \
			&PlaygroundThymio2NativeDescription_leds_sound, &PlaygroundThymio2NativeDescription_led_temperature,  \
			&PlaygroundThymio2NativeDescription_sound_wave, &PlaygroundThymio2NativeDescription_prox_comm_enable, \
			&PlaygroundThymio2NativeDescription_sd_open, &PlaygroundThymio2NativeDescription_sd_write,            \
			&PlaygroundThymio2NativeDescription_sd_read, &PlaygroundThymio2NativeDescription_sd_seek,             \
			&PlaygroundThymio2NativeDescription_sound_duration

#	define PLAYGROUND_THYMIO2_NATIVES_FUNCTIONS                                                                       \
		PlaygroundThymio2Native_sound_record, PlaygroundThymio2Native_sound_play,                                      \
			PlaygroundThymio2Native_sound_replay, PlaygroundThymio2Native_sound_system,                                \
			PlaygroundThymio2Native_leds_circle, PlaygroundThymio2Native_leds_top,                                     \
			PlaygroundThymio2Native_leds_bottom_right, PlaygroundThymio2Native_leds_bottom_left,                       \
			PlaygroundThymio2Native_sound_freq, PlaygroundThymio2Native_leds_buttons,                                  \
			PlaygroundThymio2Native_leds_prox_h, PlaygroundThymio2Native_leds_prox_v, PlaygroundThymio2Native_leds_rc, \
			PlaygroundThymio2Native_leds_sound, PlaygroundThymio2Native_leds_temperature,                              \
			PlaygroundThymio2Native_sound_wave, PlaygroundThymio2Native_prox_comm_enable,                              \
			PlaygroundThymio2Native_sd_open, PlaygroundThymio2Native_sd_write, PlaygroundThymio2Native_sd_read,        \
			PlaygroundThymio2Native_sd_seek, PlaygroundThymio2Native_sound_duration

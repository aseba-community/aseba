...
namespace Aseba
{
	...
	protected:
		...
		QString
			lastCompiledSource; //!< content of last source considered for compilation following a textChanged signal
	...
	public:
		MainWindow(
			QVector<QTranslator*> translators, const QString& commandLineTarget, bool autoRefresh, QWidget* parent = 0);
		~MainWindow();
	...
	private:
		...
		NodeTab* getTabFromName(
			const QString& name, unsigned preferedId = 0, bool* isPrefered = 0, QSet<int>* filledList = 0) const;

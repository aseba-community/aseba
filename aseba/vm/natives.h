...
/*! Embedded targets must know the size of ASEBA_NATIVES_STD_FUNCTIONS without having to compute
 * them by hand, please update this when adding a new function */

...
//! Create a Qt socket notifier in read mode for the file descriptor of the provided service
//! reference
QtZeroconf::ServiceRefSocketNotifier::ServiceRefSocketNotifier(DNSServiceRef serviceRef, QObject* parent)
    : QSocketNotifier(DNSServiceRefSockFD(serviceRef), QSocketNotifier::Read, parent), serviceRef(serviceRef) {}

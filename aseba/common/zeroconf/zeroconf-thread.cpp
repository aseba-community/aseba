...
//! Destructor, need to terminate the thread, clear all targets, and deallocate remaining service
//! references
...
//! pendingReleaseServiceRefs, so that it will be released after the current call to select has
//! completed.

...
BasicFormatableString<charT>& BasicFormatableString<charT>::argInt(intT value, int fieldWidth, int base,
                                                                   charT fillChar) {
...
BasicFormatableString<charT>& BasicFormatableString<charT>::argFloat(floatT value, int fieldWidth, int precision,
                                                                     charT fillChar) {
    typename std::basic_ostringstream<charT> oss;
...
template <typename charT>
BasicFormatableString<charT>& BasicFormatableString<charT>::arg(long int value, int fieldWidth, int base,
                                                                charT fillChar) {
    return argInt<long int>(value, fieldWidth, base, fillChar);
}

template <typename charT>
BasicFormatableString<charT>& BasicFormatableString<charT>::arg(unsigned value, int fieldWidth, int base,
                                                                charT fillChar) {
    return argInt<unsigned>(value, fieldWidth, base, fillChar);
}

template <typename charT>
BasicFormatableString<charT>& BasicFormatableString<charT>::arg(float value, int fieldWidth, int precision,
                                                                charT fillChar) {
    return argFloat<float>(value, fieldWidth, precision, fillChar);
}

template <typename charT>
BasicFormatableString<charT>& BasicFormatableString<charT>::arg(double value, int fieldWidth, int precision,
                                                                charT fillChar) {

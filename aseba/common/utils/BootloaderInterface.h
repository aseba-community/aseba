...
public:
    ...
    //! Create an interface to bootloader with id dest and different id within bootloader
    //! bootloaderDest (currently only deployed for simple mode), using a socket

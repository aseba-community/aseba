...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Πρόκειται να γράψετε νέο υλικολογισμικό στο Thymio II. Βεβαιωθείτε ότι το ρομπότ είναι φορτισμένο και ότι το καλώδιο USB είναι κατάλληλα συνδεδεμένο.&lt;p&gt;&lt;b&gt;Μην αποσυνδέσετε το ρομπότ κατά τη διάρκεια της αναβάθμισης!&lt;/b&gt;&lt;/p&gt;Είστε βέβαιοι ότι επιθυμείτε να συνεχίσετε;</translation>
    </message>
    <message>
        <location line="+48"/>
        <location line="+4"/>

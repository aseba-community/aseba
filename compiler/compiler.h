...
namespace Aseba
{
	...
	*/
	...
	{
		bool success; //!< whether last compilation was a success or a failure
		Error error; //!< error of last compilation if any
		
		// meaningful only if success was true
		unsigned allocatedVariablesCount; //!< number of variables allocated
		BytecodeVector bytecode; //!< generated bytecode 
		VariablesMap variables; //!< map of all variables (native and user-defined in the program)
		StringVector subroutinesNames; //!< names of defined subroutines
	...
	public:
		...
		StringVector getSubroutinesNames() const;

...
namespace Aseba
{
	...
	//! table of translatable errors, whose size is a constant generated by the translation update script
	static const wchar_t* error_map[ERROR_END];

	//! Populate a static table of translatable errors
	...
	//! default callback, return the error message for a given code without translation
	...
	//! Current callback for translating compiler error messages
	ErrorMessages::ErrorCallback TranslatableError::translateCB = NULL;

	//! Create an error at pos for a given code with a translated message
	...
	//! Set a new translation callback
	...
	//! convert long int argument to string
	...
	//! convert unsigned argument to string
	...
	//! convert float argument to string

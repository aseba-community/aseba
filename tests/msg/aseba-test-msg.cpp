...
int main()
{
	...
	testMessageNoInit<UserMessage>({ [](UserMessage& m) { m.data[0] = 4; },
									   [](UserMessage& m) { m.data[1] = 3; },
									   [](UserMessage& m) { m.data[2] = 2; } },
		0,
		VariablesDataVector{ 1, 2, 3 });
	...
	testMessage<GetNodeDescription>([](GetNodeDescription& m) { m.dest = 1; },
	...
	testMessage<EventExecutionKilled>(
		[](EventExecutionKilled& m) { m.pc = 10; }, { [](EventExecutionKilled& m) { m.pc = 5; } });
	...
	testMessage<GetExecutionState>(
		[](GetExecutionState& m) { m.dest = 1; }, { [](GetExecutionState& m) { m.dest = 3; } });
	...
	testMessage<BreakpointClearAll>(
		[](BreakpointClearAll& m) { m.dest = 1; }, { [](BreakpointClearAll& m) { m.dest = 3; } });

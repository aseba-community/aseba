...
// global pointer to an object of class DBusInterface, which serves as the interface to our Aseba
// network
DBusInterface* ThymioIIInterface;

// Example of a custom callback function, to connect to ThymioIIInterface
// Note: connected callbacks need not be global (see std::function documentation in C++11 for more
// information)

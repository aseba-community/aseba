...
DBusInterface::DBusInterface()
    ...
    if(!bus.connect("ch.epfl.mobots.Aseba", eventfilterPath.path(), "ch.epfl.mobots.EventFilter", "Event", this,
...
// Convert  QDBusMessage to QList<qint16> Values, extracting data at a particular index of the
// construct

...
static const int16_t aseba_atan_table[20 * 8 + 1] = { 652,
	735,
	816,
	896,
	977,
...
const AsebaNativeFunctionDescription AsebaNativeDescription_vecaddscalar = { "math.addscalar",
...
const AsebaNativeFunctionDescription AsebaNativeDescription_vecadd = { "math.add",
...
const AsebaNativeFunctionDescription AsebaNativeDescription_vecsub = { "math.sub",
...
const AsebaNativeFunctionDescription AsebaNativeDescription_vecmul = { "math.mul",
...
const AsebaNativeFunctionDescription AsebaNativeDescription_vecdiv = { "math.div",
...
const AsebaNativeFunctionDescription AsebaNativeDescription_vecmin = { "math.min",
...
const AsebaNativeFunctionDescription AsebaNativeDescription_vecmax = { "math.max",
...
const AsebaNativeFunctionDescription AsebaNativeDescription_vecclamp = { "math.clamp",
...
const AsebaNativeFunctionDescription AsebaNativeDescription_vecdot = { "math.dot",
...
const AsebaNativeFunctionDescription AsebaNativeDescription_vecstat = { "math.stat",
...
const AsebaNativeFunctionDescription AsebaNativeDescription_vecargbounds = { "math.argbounds",
...
const AsebaNativeFunctionDescription AsebaNativeDescription_mathmuldiv = { "math.muldiv",
...
const AsebaNativeFunctionDescription AsebaNativeDescription_mathatan2 = { "math.atan2",
...
const AsebaNativeFunctionDescription AsebaNativeDescription_vecnonzerosequence = { "math.nzseq",
	"write to dest the middle index of the largest sequence of non-zero elements from src, -1 if not found or if "
...
static void deque_shift(
	AsebaVMState* vm, uint16_t dq, uint16_t dq_capacity, uint16_t target, int16_t last, int16_t delta)
{
...
static void _AsebaNative_deqget(
	AsebaVMState* vm, uint16_t dest, uint16_t deque, uint16_t index_val, uint16_t dest_length, uint16_t deque_length)
{
...
const AsebaNativeFunctionDescription AsebaNativeDescription_deqget = { "deque.get",
...
const AsebaNativeFunctionDescription AsebaNativeDescription_deqset = { "deque.set",
	"copies src to deque at index",
	{ { -1, "deque" }, { -2, "src" }, { 1, "index" }, { 0, 0 } } };

static void _AsebaNative_deqinsert(
	AsebaVMState* vm, uint16_t deque, uint16_t src, uint16_t index_val, uint16_t deque_length, uint16_t src_length)
{
	// infer deque parameters
	uint16_t dq_size = vm->variables[deque];
	uint16_t dq_start = vm->variables[deque + 1];
...
const AsebaNativeFunctionDescription AsebaNativeDescription_deqinsert = { "deque.insert",
	"shift deque at index by len(src) and insert src",
	{ { -1, "deque" }, { -2, "src" }, { 1, "index" }, { 0, 0 } } };

static void _AsebaNative_deqerase(
	AsebaVMState* vm, uint16_t deque, uint16_t index_val, uint16_t len_val, uint16_t deque_length)
{
	// infer deque parameters
	uint16_t dq_size = vm->variables[deque];
	uint16_t dq_start = vm->variables[deque + 1];
...
const AsebaNativeFunctionDescription AsebaNativeDescription_deqerase = { "deque.erase",
...
const AsebaNativeFunctionDescription AsebaNativeDescription_deqpopfront = { "deque.pop_front",
...
void AsebaNative_deqpopback(AsebaVMState* vm)
{
	...
	uint16_t index_val =
		vm->variables[deque]; // length of deque is index value, from which tuple length will be subtracted
...
const AsebaNativeFunctionDescription AsebaNativeDescription_deqpopback = { "deque.pop_back",
